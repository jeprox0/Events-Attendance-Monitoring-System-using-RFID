                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <div class="d-flex justify-content-center">
                            <!-- Edit button -->
                            <button type="button" class="Btn me-3" data-bs-toggle="modal" data-bs-target="#editStudentModal{{ $club->id }}">
                                Edit
                            ...
                            <!-- Delete button -->
                            <form id="delete-form-{{ $club->id }}" action="{{ route('clubs.destroy', $club->id) }}" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                            
                            <button type="button" class="btn btn-danger" style="padding: 4px 8px; font-size: 0.9rem;" onclick="confirmDelete({{ $club->id }})">
                                Delete
                            </button>

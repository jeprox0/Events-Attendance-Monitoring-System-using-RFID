            ...
            <table id="example" class="table table-striped table-bordered " cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ ucfirst($officer->student->first_name) }} {{ ucfirst($officer->student->last_name) }}</td>
                        <td>
                            @if($officer->student->clubs->isNotEmpty())
                        ...
                        <td>{{ ucfirst($officer->position_name) }}</td>
                        <td>
                            <div class="d-flex justify-content-center">
                            <button type="button" class="Btn me-3" data-bs-toggle="modal" data-bs-target="#editUserModal{{ $officer->id }}">
                                Edit
                            ...
                            <form id="delete-form-{{ $officer->id }}" action="{{ route('officers.destroy', $officer->id) }}" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                            <button type="button" class="btn btn-danger" style="padding: 4px 8px; font-size: 0.9rem;" onclick="confirmDelete({{ $officer->id }})">
                                Delete
                            </button>
